...
(function () {
  ...
  ContentDirector.prototype.mount = function () {
    ...
    this.register('pricing-panel', function () {
      ...
      p.appendChild(el('h3', 'ol-panel-title', 'What Arcadia builds'));
      var rows = el('div', 'ol-panel-rows');
      [
        { id: 'block', name: 'Block wall', desc: 'Privacy, security, quiet. Decorative caps and toppers, HOA-safe heights, reinforced.', price: 'Free estimate' },
        { id: 'steel', name: 'Steel view fence', desc: 'Modern lines, zero warp, maximum sightlines. Powder-coated — pools, patios, perimeters.', price: 'Free estimate' },
        { id: 'wood', name: 'Wood privacy', desc: 'Cedar and treated lumber, horizontal or vertical slats, built for the Arizona climate.', price: 'Free estimate' },
        { id: 'vinyl', name: 'Vinyl', desc: 'UV-resistant privacy, picket, and ranch-rail styles. No repainting, ever.', price: 'Free estimate' },
        { id: 'gate', name: 'Custom gate', desc: 'Manual or automated — keypads, remotes, smart access. Pedestrian and vehicular.', price: 'Free estimate' }
      ].forEach(function (r) {
      ...
      p.appendChild(rows);
      p.appendChild(el('p', 'ol-panel-note mono', 'Every estimate is free. Financing available with flexible monthly plans.'));
      return p;
    });
