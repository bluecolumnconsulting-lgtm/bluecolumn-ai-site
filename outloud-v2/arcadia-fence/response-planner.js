...
(function () {
  ...
  var GREETINGS = [
    "Hey there{NAME}. I'm Buddy, the Arcadia Fence and Gate agent. Ask me anything — block walls, steel view fencing, gates, pricing — or say quote and I'll start your free estimate.",
    "Hi{NAME}, good to see you. I can cover materials, gates, financing, the service area, or get a free estimate started. What's on your mind?",
    "Hello{NAME}. I'm Buddy, and this page is me — Arcadia out loud. Fire away with questions, or say book a walkthrough."
  ];
  var FOLLOWUPS = [
  ...
  Planner.prototype.produce = function (turn) {
    ...
    switch (intent) {
      ...
      case 'contact': {
        speech = "Easiest path: call Arcadia at 480-906-9605 or email arcadiafencegate@gmail.com — or leave your name and number and Arcadia calls you. Which do you prefer?";
