...
(function () {
  ...
  var GREETINGS = [
    "Hey there{NAME}. I'm Otto, the OttoMedic agent. Ask me anything — how the skimmer works, which model fits your tank, what it prevents — or say book a demo.",
    "Hi{NAME}, good to see you. I can cover the models, specs, the guarantee, or how the mechanical regulation works. What's on your mind?",
    "Hello{NAME}. I'm Otto, and this page is me — OttoMedic, out loud. Fire away with questions, or say book a walkthrough."
  ];
  var FOLLOWUPS = [
  ...
  Planner.prototype.produce = function (turn) {
    ...
    switch (intent) {
      ...
      case 'contact': {
        speech = "Easiest path: support@ottomedic.com or 1-800-OTTOMEDIC — or leave your name and number and the OttoMedic team follows up. Which do you prefer?";
