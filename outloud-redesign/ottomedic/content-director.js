...
(function () {
  ...
  ContentDirector.prototype.mount = function () {
    ...
    this.register('pricing-panel', function () {
      ...
      [
        { id: 'evo5000', name: 'EVO 5000Z1', desc: '100 to 200 heavily stocked gallons. Needle wheel impeller, purely mechanical regulation.', price: '$899' },
        { id: 'evo7000', name: 'EVO 7000Z1', desc: '200 to 400 gallons. External or in-sump install, 7 to 9.5 inch water level range.', price: '$1,149' },
        { id: 'evo9000', name: 'EVO 9000Z1', desc: '400 to 600 gallons. Quarter-inch cast acrylic chamber, marine-grade stainless fittings.', price: '$1,399' },
        { id: 'guarantee', name: 'The promises', desc: '60-day performance guarantee — outperform your current skimmer or full refund. 5-year warranty.', price: 'Included' }
      ].forEach(function (r) {
      ...
      p.appendChild(rows);
      p.appendChild(el('p', 'ol-panel-note mono', 'Made in Germany, ISO 9001 certified. Free technical support.'));
      return p;
    });
